export default class AppView {
  ...
  render() {
    const listOfItems = document.getElementsByTagName('ul')[0];
    if (listOfItems) {
      listOfItems.innerHTML = this.data.map(item => `<li class="main__clips__item">
      <div class="clip-inner">
        <img  class="clip-inner__image" src="${item.img}" alt="${item.channel}">
